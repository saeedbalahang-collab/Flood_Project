# ============================================================
# Script 04 of 07 - (a) Supplementary extreme flood event analysis
#                        on the main test set
#                    (b) Full preparation of the raw spatial-transfer
#                        data (cleaning + feature engineering + scaling)
#
# Requirement for part (a): the output of scripts 01 and 03
# Requirement for part (b): the raw spatial_transfer_all.zip data,
#                           downloaded automatically from GitHub.
# Models and scaler are only loaded - training is never repeated.
# ============================================================
